    ...
    <main class="main_index">
        <div>
            <div class="caja_login">
                ...
                <h3 class="h3_login">Iniciar sesión</h3> 
                <form autocomplete="off" id="Iniciar_Sesion" name="Iniciar_Sesion" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="caja_campo2">
                        <p>Contraseña</p>
                        <input type="password" name="txt_contraseña" id="txt_contraseña" placeholder="••••••••••••">
                    </div>
