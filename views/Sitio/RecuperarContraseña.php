...
<div id="CajaPrincipal">
    <div class="row">
                    ...
                    <div class="card" id="ContenidoLogin">
                        ...
                        <div class="card-content">
                            ...
                            <div class="input-field col l12 m12 s12">
                                ...
                                <input id="txt_usuario" type="text" name="txt_usuario" class="validate"  autocomplete = "off" minlength="8" maxlength="30" oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false" required/>
                                <label for="txt_usuario" id="lbr1">Usuario</label>
                            </div>
                            <div class="input-field col l12 m12 s12">
                                <i class="material-icons prefix">contact_mail</i>
                                <input id="txt_correo_usuario" type="email" class="validate" name="txt_correo_usuario"  autocomplete = "off" minlength="15" maxlength="100" oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false" required/>
            ...
            <div id="divpaso2">
                <div class="card-panel z-depth-5 center-align" id="CajaLogin3">
                    <div class="card" id="ContenidoLogin">
                        ...
                        <div class="card-content">
                            <form action="" name = "Paso2" id = "Paso2" autocomplete="off" method="POST" enctype="multipart/form-data">
                            <div class="input-field col l12 m12 s12">
                                <i class="material-icons prefix">fiber_pin</i>
                                <input id="txt_codigo" type="text" name="txt_codigo"  class="validate" " minlength="6" maxlength="6" oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false" required/>
                                <label for="txt_codigo" id="lbr3">Código</label>
                            </div>
                            <div class="input-field col l12 m12 s12">
                                <i class="material-icons prefix">fiber_pin</i>
                                <input id="txt_codigo2" type="text" name="txt_codigo2" class="validate" " minlength="6" maxlength="6" oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false" required/>
        ...
        <div class="col l4 m6 s12">
            <div id="divpaso3">
                <div class="card-panel z-depth-5 center-align" id="CajaLogin3">
                    <div class="card" id="ContenidoLogin">
                        ...
                        <div class="card-content">
                            <form action="" id = "Paso3" name = "Paso3" autocomplete="off" method="POST" enctype="multipart/form-data">
                            <div class="input-field col l12 m12 s12">
                                <i class="material-icons prefix">lock</i>
                                <input id="txt_contraseña_usuario" type="password" name="txt_contraseña_usuario" class="validate" minlength="6" maxlength="60" required oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false"/>
                                <label for="txt_contraseña_usuario" id="lbr5">Contraseña</label>
                            </div>
                            <div class="input-field col l12 m12 s12">
                                <i class="material-icons prefix">lock</i>
                                <input id="txt_contraseña_usuario2" type="password" name="txt_contraseña_usuario2" class="validate"  minlength="6" maxlength="60" required oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false"/>
            ...
            <script src="../../core/controllers/recuperar.js" type="text/javascript"></script>
