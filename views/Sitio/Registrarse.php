...
<div id="CajaPrincipal">
        <div class="row">
                    ...
                    <div class="card" id="ContenidoLogin">
                            <div class="card-action red white-text"> 
                                ...
                                <div class="card-content">
                                    <form action="" name = "Registrarse" id = "Registrarse" autocomplete = "off" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" id="g-recaptcha-response" name="g-recaptcha-response"/>
                                    <div class="input-field col s12 m6">
                                        <i class="material-icons prefix">contact_mail</i>
                                        <input id="txt_correo_usuario" type="email" name="txt_correo_usuario" class="validate" required autocomplete = "off" minlength="15" maxlength="100" required oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false"/>
                                        <label for="txt_correo_usuario" id="lb3">Correo</label>
                                    </div>
                                    <div class="input-field col s12 m6">
                                        <i class="material-icons prefix">account_circle</i>
                                        <input id="txt_usuario" type="text" name="txt_usuario" class="validate" required autocomplete = "off" minlength="8" maxlength="30" required oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false"/>
                                        <label for="txt_usuario" id="lb4">Usuario</label>
                                    </div>
                                    <div class="input-field col s12 m6">
                                        <i class="material-icons prefix">lock</i>
                                        <input id="txt_contraseña_usuario" type="password" name="txt_contraseña_usuario" class="validate" required autocomplete = "off" minlength="6" maxlength="60" required oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false"/>
                                        <label for="txt_contraseña_usuario" id="lb5">Contraseña</label>
                                    </div>
                                    <div class="input-field col s12 m6">
                                        <i class="material-icons prefix">lock</i>
                                        <input id="txt_contraseña_usuario2" type="password" name="txt_contraseña_usuario2" class="validate" required autocomplete = "off" minlength="6" maxlength="60" required oncopy="return false" oncut="return false" onpaste="return false" oncut="return false" onpaste="return false"/>
            ...
            <script src="../../core/controllers/registrarse.js" type="text/javascript"></script>
