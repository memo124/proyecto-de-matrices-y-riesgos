...
*   Creación de la clase Reporte heredada de la clase FPDF 
    que definie la plantilla del reporte.
*/
class Reporte extends FPDF
{
    ...
    public function reportHeader($title)
    {
        ...
        if($_SESSION['LEVEL'] == 'S' || $_SESSION['LEVEL'] == 'A'){
            ...
            if ( isset($_SESSION['ROWID']) ) {
                ...
                header('location: ../../views/Sitio/index.php');
            }
        }else{
    ...
    public function header()
    {
        ...
        /*Se imprime la celda que contiene el nombre del usuario que genero el reporte*/
        $this->Cell(166, 10, 'Reporte generado por: '.$_SESSION['USER_ID'], 0, 1, 'C');
        $this->Cell(20);
        /*Se imprime la celda que contiene la fecha y la hora del servidor*/
        $this->Cell(166, 10, 'Fecha/Hora: '.date('d-m-Y H:i:s'), 0, 1, 'C');
        // Se añade un salto de línea para mostrar la información principal del reporte a imprimir.
        $this->Ln(10);
    }
    ...
    public function footer()
    {
        ...
        //Se indica la posición del número de página (a 15 milimetros del final del reporte).
        $this->SetY(-15);
